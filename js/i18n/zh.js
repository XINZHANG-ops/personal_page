...
const translations_zh = {
    ...
    hero: {
        ...
        prefix: "我是一个 ",
        subtitle: "创造者",
        description: "我的工作是数据科学家，热衷于将想法落地成真实的项目。我平时尽量让自己跟上人工智能的最新进展，学习最新的技术方法，最近也要开展新的学习包括虚幻引擎5等我感兴趣的技术。",
        contactBtn: "联系我",
        projectsBtn: "项目展示",
        writingBtn: "文章作品"
    },
    ...
    about: {
        title: "关于我",
        subtitle: "连接研究与产业",
        text: "我的工作是数据科学家，现在住在加拿大滑铁卢，目前就职于Geotab。我目前的工作重点是搭建生产级生成式AI系统，包括人工智能对话Agent和大规模检索系统，这部分工作结合了向量数据库、知识图谱、语义排序、智能体、SQL生成等等一系列技术。\n\n在本职工作之外，我也热衷于做自己的项目，最近热衷于强化学习、进化算法和三维重建技术。具体一些讲比如说基于强化学习的赛车模拟器、本地开源LLM的智能体虚拟游戏以及3D重建模型（NeRF、高斯溅射）。我还每周撰写关于AI研究者和算法的文章，也融合了很多个人思考。\n\n我重视算法讲解，喜欢条理清晰而非抽象罗列概念，重视坚持的力量。无论是写代码、阅读论文还是业余项目，我都尽量将AI整合到我的工作流程之中。",
        skillsTitle: "技能与技术",
    ...
    beer: {
        title: "啤酒自评",
        subtitle: "品鉴各种啤酒",
        description: "除了AI和编程，我还喜欢探索喝点啤酒。我开发了自己的评分系统（全是主观，没有客观🤪），从几个维度随意评价，从风味特征到整体体验🍺。每款啤酒都会得到一个非正式的评价⭐。",
        viewBtn: "查看我的啤酒评鉴 →",
        heroTitle: "🍺 啤酒评分评鉴",
