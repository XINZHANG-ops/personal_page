...
const translations_zh = {
    ...
    hero: {
        ...
        prefix: "我是一个 ",
        subtitle: "创造者",
        description: "我是一位热情的数据科学家，热衷于将想法转化为生动、富有创意的项目。我紧跟人工智能的最新进展，不断学习探索前沿技术，包括虚幻引擎5等我感兴趣的技术。",
        contactBtn: "联系我",
        projectsBtn: "项目展示",
        writingBtn: "文章作品"
    },
    ...
    beer: {
        ...
        viewBtn: "查看我的啤酒评鉴 →",
        heroTitle: "🍺 啤酒评分评鉴",
        heroDescription: "我对精酿啤酒的个人评分，涵盖6个关键方面：麦芽香、颜色深浅、清澈度、苦度、其他香味和综合评价。每项的评分范围为1-10分。",
        sortLabel: "排序方式：",
        sortOverall: "综合评分",
        sortMaltiness: "麦芽香",
        sortColorDepth: "颜色深浅",
