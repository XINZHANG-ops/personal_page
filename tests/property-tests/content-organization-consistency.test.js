...
describe('Property 3: Content Organization Consistency', () => {
    ...
    fc.assert(fc.property(
      fc.array(
        fc.record({
          ...
          type: fc.constantFrom('blog-post', 'research-paper', 'article'),
  ...
  it('should handle writing entries with different content types consistently', () => {
    // Property: Different content types (blog-post, research-paper, article) should have consistent structure
    
    fc.assert(fc.property(
      fc.constantFrom('blog-post', 'research-paper', 'article'),
      fc.record({
        id: fc.string({ minLength: 1, maxLength: 50 }),
        title: fc.string({ minLength: 1, maxLength: 100 }),
        venue: fc.string({ minLength: 1, maxLength: 100 }),
